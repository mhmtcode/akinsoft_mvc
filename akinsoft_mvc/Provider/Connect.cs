...
namespace akinsoft_mvc.Provider
{
    public class Connect
    {
        ...
        public Connect()
        {
            ...
            {
                //build connection
                _Connection = new SQLiteConnection("Data Source=" + HttpContext.Current.Server.MapPath("~/App_Data/ak_data.db"));
